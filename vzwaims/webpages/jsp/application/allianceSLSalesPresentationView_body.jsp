				...
				<tr>
					<td align="left">
						<logic:notEqual name="spotlight" property="status" value="ACCEPT">
							<a href='/aims/entAppsSpotLightSetup.do?task=editForm&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_SALES_PRESENTATION%>&spotlightId=<bean:write name="spotlight" property="spotlightId"/>&enterpriseAppsId=<%=enterpriseAppsId%>' class="a">
					...
					<td align="center" style="vertical-align: middle">
	                <%if (AimsSecurityManager.checkAccess(request, "SPOTLIGHT_PAGE", AimsSecurityManager.DELETE)) {	%>					
						<a href='/aims/entAppsSpotlights.do?task=delete&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_SALES_PRESENTATION%>&spotlightId=<bean:write name="spotlight" property="spotlightId"/>&enterpriseAppsId=<%=enterpriseAppsId%>' class="a">
	             ...
	             <tr> 
	                 <td colspan="8" align="right" > 
	                 	<div class="redBtn" style=" margin-left:5px;float:right; margin-top:3px" id="Create"
	                          title="Create">
	                         <div>
	                             <div><div onclick="window.location='/aims/entAppsSpotLightSetup.do?task=createForm&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_SALES_PRESENTATION%>&enterpriseAppsId=<%=enterpriseAppsId%>'">Create</div></div>
	                         </div>
	                     </div>
	                 </td>
	             </tr>
