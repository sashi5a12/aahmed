...
<html:form action="/entSalesCollateralEdit.do" enctype="multipart/form-data" onsubmit="showProcessingInfoPopup()">

    <html:hidden property="spotlightTypeId" value="<%=AimsConstants.SPOTLIGHT_SALES_COLLATERAL%>"/>
