...
<script type="text/javascript">
    ...
    function submitFilter() {
        ...
        //alert("document.forms[2].filterField.value   "+document.forms[0].filterField.value);
        
        document.forms[0].filterField.value = document.forms[0].filterField.value;
        document.forms[0].filterText.value = document.forms[0].filterText.value;
...
<html:form action="/approvedJavaApps.do" onsubmit="return false;">
