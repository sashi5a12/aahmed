...
<aims:getEntSpotlightsTab attributeName="<%=AimsConstants.SPOTLIGHT_SALES_PRESENTATION%>"
                          enterpriseAppsId="<%=enterpriseAppsId%>"/>

<html:form action="/entSalesPresentationEdit.do" enctype="multipart/form-data" onsubmit="showProcessingInfoPopup()">

    <html:hidden property="spotlightTypeId" value="<%=AimsConstants.SPOTLIGHT_SALES_PRESENTATION%>"/>
        ...
        <table width="100%" cellspacing="0" cellpadding="5" class="GridGradient">
            <tr>
                <th style="text-align:right;">
                    <strong>Sales Presentation Name&nbsp;<span class="requiredText">*</span>:</strong>
                </th>
                <th align="left">
            ...
            <tr>
                ...
                <td align="left">
                    <html:textarea property="spotlightDesc" rows="4" cols="50"
            ...
            <tr>
                <td align="right">
                    <strong>Sales Presentation Document&nbsp;<span class="requiredText">*</span>:</strong>
                </td>
                <td align="left">
