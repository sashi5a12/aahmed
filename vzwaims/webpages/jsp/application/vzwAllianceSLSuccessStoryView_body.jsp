						...
						<td align="center">
							<logic:equal name="spotlight" property="status" value="NEW">
								<div class="redSmallBtn" id="Create" title="Accept">
									<div><div>
										<div
											onclick="window.location='/aims/entAppsSpotlights.do?task=changeStatus&enterpriseAppsId=<%=enterpriseAppsId%>&vzwStatus=ACCEPT&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_SUCCESS_STORY%>&spotlightId=<bean:write name="spotlight" property="spotlightId"/>'">
											Accept
										</div>
									</div></div>
								</div>
							...
							<logic:equal name="spotlight" property="status" value="NEW">
								<div class="redSmallBtn" id="Create" title="Reject">
									<div>
										<div>
											<div
												onclick="window.location='/aims/entAppsSpotlights.do?task=changeStatus&enterpriseAppsId=<%=enterpriseAppsId%>&vzwStatus=REJECT&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_SUCCESS_STORY%>&spotlightId=<bean:write name="spotlight" property="spotlightId"/>'">
												Reject
											</div>
										</div>
									</div>
