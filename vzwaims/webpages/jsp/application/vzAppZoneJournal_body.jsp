...
<%VZAppZoneApplicationUpdateForm.setCurrentPage("vzAppZoneJournal");%>
				...
				<td	height="25"	align="right" valign="middle">
					<div id="divButtons">
						<div class="redBtn" style="float:right; margin-left:10px; margin-top:3px" id="SubmitAll" title="Submit">
							<div><div><div onClick="document.forms[0].appSubmitType.value='paging';document.forms[0].task.value='submitVZAppZoneJournal';showProcessingInfo();document.forms[0].submit();">Submit</div></div></div>
						</div>
					</div>
				</td>
			</tr>
