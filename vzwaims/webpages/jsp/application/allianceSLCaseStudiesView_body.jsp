...
<div class="homeColumnTab lBox">
	...
	<aims:getEntSpotlightsTab attributeName="<%=AimsConstants.SPOTLIGHT_CASE_STUDY%>" enterpriseAppsId="<%=enterpriseAppsId%>" />
	...
	<div class="contentbox">
		<table width="100%" cellspacing="0" cellpadding="5" class="Grid2" border="1">
			<tr>
				<th align="center"><strong>Case Study Name</strong></th>
				<th align="center"><strong>Case Study Description</strong></th>
				<th align="center"><strong>Case Study Document</strong></th>
				...
				<tr>
					<td align="left">
						<logic:notEqual name="spotlight" property="status" value="ACCEPT">
							<a href='/aims/entAppsSpotLightSetup.do?task=editForm&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_CASE_STUDY%>&spotlightId=<bean:write name="spotlight" property="spotlightId"/>&enterpriseAppsId=<%=enterpriseAppsId%>' class="a">
					...
					<td align="center">
						<logic:notEqual name="spotlight" property="status" value="ACCEPT">
							<a class="a"
								href="/aims/entAppsSpotLightSetup.do?task=editForm&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_CASE_STUDY%>&spotlightId=<bean:write name="spotlight" property="spotlightId"/>&enterpriseAppsId=<%=enterpriseAppsId%>">
					...
					<td align="center">
						<a class="a"
							href="/aims/entAppsSpotlights.do?task=delete&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_CASE_STUDY%>&spotlightId=<bean:write name="spotlight" property="spotlightId"/>&enterpriseAppsId=<%=enterpriseAppsId%>">
               ...
               <tr> 
                   <td  align="right" > 
                   	<div class="redBtn" style=" margin-left:5px;float:right; margin-top:3px" id="Create"
                            title="Create">
                           <div>
                               <div><div onclick="window.location='/aims/entAppsSpotLightSetup.do?task=createForm&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_CASE_STUDY%>&enterpriseAppsId=<%=enterpriseAppsId%>'">Create</div></div>
                           </div>
                       </div>
                   </td>
               </tr>
