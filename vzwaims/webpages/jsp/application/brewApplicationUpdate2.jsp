...
<tiles:insert beanName="classicLayout" beanScope="request">
  <tiles:put name="body" value="/application/brewApplicationUpdate2_body.jsp"/>
  <tiles:put name="headingText">
	<%--<bean:message key="BrewApplicationForm.welcome"	bundle="com.netpace.aims.action.MANAGE_APPLICATION_MESSAGE"/> - --%>
