...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr> 
  	...
  	<tr> 
    	<td width="20">&nbsp;</td>
       	<td width="100%">
            <aims:getSpotlightsTab attributeName="<%=AimsConstants.SPOTLIGHT_SUCCESS_STORY%>"/>	
       	</td>
  	</tr>
	<tr> 
		<td width="20">&nbsp;</td>
  	...
  	<tr> 
    	...
    	<td align="center" valign="middle" bgcolor="#FFFFFF">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				%>
								...
								<tr>
									<td class="firstcell" align="left">
										<a href='/aims/allianceSpotLightSetup.do?task=editForm&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_SUCCESS_STORY%>&spotlightId=<bean:write name="spotlight" property="spotlightId"/>' class="modulecontentlink">
				...
				%>                                    
									<td class="cell" align="center">
										<a href='/aims/allianceSpotlights.do?task=delete&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_SUCCESS_STORY%>&spotlightId=<bean:write name="spotlight" property="spotlightId"/>' class="modulecontentlink">
                ...
                <tr> 
                    <td height="25" align="right" valign="middle"> 			
						<a href="/aims/allianceSpotLightSetup.do?task=createForm&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_SUCCESS_STORY%>">
