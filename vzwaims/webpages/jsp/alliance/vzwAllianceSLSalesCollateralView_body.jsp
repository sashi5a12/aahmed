...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr> 
		<td width="20">&nbsp;</td>
		<td width="100%">
            <aims:getSpotlightsTab attributeName="<%=AimsConstants.SPOTLIGHT_SALES_COLLATERAL%>" allianceId="<%=request.getParameter("alliance_id")%>" />	
		</td>
	</tr>
	<tr> 
		<td width="20">&nbsp;</td>
				...
				%>
								<td class="cell" align="center">
                                    <logic:equal name="spotlight" property="status" value="NEW">
                                        <a href='/aims/allianceSpotlights.do?task=changeStatus&alliance_id=<%=alliance_id%>&vzwStatus=ACCEPT&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_SALES_COLLATERAL%>&spotlightId=<bean:write name="spotlight" property="spotlightId"/>' class="modulecontentlink">
								...
								<td class="cell" align="center">
                                    <logic:equal name="spotlight" property="status" value="NEW">
                                        <a href='/aims/allianceSpotlights.do?task=changeStatus&alliance_id=<%=alliance_id%>&vzwStatus=REJECT&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_SALES_COLLATERAL%>&spotlightId=<bean:write name="spotlight" property="spotlightId"/>' class="modulecontentlink">
