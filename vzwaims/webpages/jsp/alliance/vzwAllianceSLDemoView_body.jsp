...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
        ...
        <td	width="100%">
            <aims:getVZWAllianceTab attributeName="Tools" allianceId="<%=alliance_id%>"/>           
        </td>
    </tr>
    <tr>
		<td	width="20">
	...
	<tr> 
		<td width="20">&nbsp;</td>
		<td width="100%">
            <aims:getSpotlightsTab attributeName="<%=AimsConstants.SPOTLIGHT_DEMO%>" allianceId="<%=alliance_id%>" />	
		</td>
	</tr> 
	<tr> 
		<td width="20">&nbsp;</td>
               ...
               %>
							...
							<tr>
								<td class="firstcell" align="left">
									<a href='/aims/allianceSpotLightSetup.do?task=editForm&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_DEMO%>&spotlightId=<bean:write name="spotlight" property="spotlightId"/>' class="modulecontentlink">
								...
								<td class="cell" align="left">									
									<a class="a" target="_blank" 									<a class="a" target="_blank" href='/aims/spotLightResourceAction.do?resource=spotlightFile&resourceId=<bean:write name="spotlight" property="spotlightId"/>' >
				...
				%>                                
								<td class="cell" align="center">		
                                    <logic:equal name="spotlight" property="status" value="NEW">
                                        <a href='/aims/allianceSpotlights.do?task=changeStatus&alliance_id=<%=alliance_id%>&vzwStatus=ACCEPT&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_DEMO%>&spotlightId=<bean:write name="spotlight" property="spotlightId"/>' class="modulecontentlink">
								...
								<td class="cell" align="center">
                                    <logic:equal name="spotlight" property="status" value="NEW">
                                        <a href='/aims/allianceSpotlights.do?task=changeStatus&alliance_id=<%=alliance_id%>&vzwStatus=REJECT&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_DEMO%>&spotlightId=<bean:write name="spotlight" property="spotlightId"/>' class="modulecontentlink">
