...
<%@ page import="com.netpace.aims.model.masters.*, com.netpace.aims.model.alliance.*, com.netpace.aims.util.*, com.netpace.aims.bo.security.*;"%>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr> 
		<td width="20">&nbsp;</td>
		<td width="100%">
           <aims:getSpotlightsTab attributeName="<%=AimsConstants.SPOTLIGHT_CASE_STUDY%>" allianceId="<%=request.getParameter("alliance_id")%>" />          
		</td>
	</tr> 
	<tr> 
		<td width="20">&nbsp;</td>
	...
	<tr> 
		...
		<td colspan="2"> 
			<table class="sectable" width="100%">
						...
						<table width="100%" class="tabletop" cellspacing="0" cellpadding="5">
							<tr bgcolor="#BBBBBB"> 
								...
								<td class="cell" align="center">
									<span class="modFormFieldLbl">Case Study Description</span>
								</td>
								<td class="cell" align="center">
				...
				%>
								<td class="cell" align="center">
									<span class="modFormFieldLbl"><bean:message key="AccountForm.edit" bundle="com.netpace.aims.action.ACCOUNTS_MESSAGE"/></span>
								</td>
								<td class="cell" align="center">
									<span class="modFormFieldLbl"><bean:message key="AccountForm.delete" bundle="com.netpace.aims.action.ACCOUNTS_MESSAGE"/></span>
								</td>
               <%
                }
               %>
				...
				%>
								<td class="cell" align="center">
                                    <logic:equal name="spotlight" property="status" value="NEW">
                                        <a href='/aims/allianceSpotlights.do?task=changeStatus&alliance_id=<%=alliance_id%>&vzwStatus=ACCEPT&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_CASE_STUDY%>&spotlightId=<bean:write name="spotlight" property="spotlightId"/>' class="modulecontentlink">
								...
								<td class="cell" align="center">
                                    <logic:equal name="spotlight" property="status" value="NEW">
                                        <a href='/aims/allianceSpotlights.do?task=changeStatus&alliance_id=<%=alliance_id%>&vzwStatus=REJECT&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_CASE_STUDY%>&spotlightId=<bean:write name="spotlight" property="spotlightId"/>' class="modulecontentlink">
