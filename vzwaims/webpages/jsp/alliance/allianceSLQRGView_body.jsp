...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr> 
  	...
  	<tr> 
    	<td width="20">&nbsp;</td>
       	<td width="100%">
            <aims:getSpotlightsTab attributeName="<%=AimsConstants.SPOTLIGHT_QRG%>"/>	
       	</td>
  	</tr>
	<tr> 
		<td width="20">&nbsp;</td>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr><td width="100%">
					<table class="sectable" width="100%" height="100%">
						<tr class="sectitle"><td class="aimssecheading">Quick Reference Guide</td></tr>
						<tr><td>
							<table width="100%" class="tabletop" cellspacing="0" cellpadding="0">
								...
								<tr>
									<td class="firstcell" align="left">
										<a href='/aims/allianceSpotLightSetup.do?task=editForm&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_QRG%>&spotlightId=<bean:write name="spotlight" property="spotlightId"/>' class="modulecontentlink">
									...
									<td class="cell" align="center">
										<a href='/aims/allianceSpotlights.do?task=delete&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_QRG%>&spotlightId=<bean:write name="spotlight" property="spotlightId"/>' class="modulecontentlink">
            ...
            <logic:equal name="showCreateButton" value="Y">
                <tr> 
                    <td height="25" align="right" valign="middle"> 			
						<a href="/aims/allianceSpotLightSetup.do?task=createForm&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_QRG%>">
