...
<!--
	function submitReq(iTask)
	{
		if (iTask == 1)
		{
			document.forms[0].task.value='accept';
		...
		{
			document.forms[0].task.value='preaccept';
			document.forms[0].submit();
		}
	}
//-->
      ...
      <td align="center" valign="middle"> 
									...
									<logic:notEmpty name="ApplicationNamesList">
										<logic:iterate id="appsName" name="ApplicationNamesList">
											...
											<span class="modFormFieldLbl">
                                                <bean:write name="appsName" property="appTitle" />
                                                <logic:present name="appsName" property="status">
                                                    <logic:equal name="appsName" property="status" value="ACCEPTED">
                                                    </logic:equal>	
                                                </logic:present>
												 (<bean:write name="appsName" property="developerName"/>)
												 <logic:present name="appsName" property="contentUsagePermission">
												  	[Permission - <logic:equal name="appsName" property="contentUsagePermission" value="G">General Usage</logic:equal><logic:equal name="appsName" property="contentUsagePermission" value="E">Event Based</logic:equal>]
										         </logic:present>
												  </span> 
                                                  
                                                  <% if (isVerizonUser) { %>
                                                      <logic:present name="appsName" property="status"><span class="text">[Current Status: <bean:write name="appsName" property="status" />]</span></logic:present>
                                                  <% } else if (isAllianceUser) { %>
                                                      <logic:present name="appsName" property="userStatus"><span class="text">[Current Status: <bean:write name="appsName" property="userStatus" />]</span></logic:present>
                                                  <% } else {} %>
                                                                                    
                                                  <input type="hidden" name="appsIds" value="<bean:write name="appsName" property="applicationId"/>"><br/>
			...
			<tr><td width="100%">&nbsp;</td></tr>
				...
				<tr><td width="100%" align="right">
					<a href="javascript:submitReq(3);//"><img src="images/process_request_b.gif" width="115"  height="15" border="0"></a>&nbsp;
                    <% if (isVerizonUser) { %>
                        <a href="javascript:submitReq(2);//"><img src="images/reject_b.gif" width="52" height="15" border="0"></a>&nbsp;
                    <% } else {} %>
                    <a href="newMktAdminContentRequest.do"><img src="images/cancel_b.gif" width="52" height="15" border="0"></a>
				</td></tr>
