...
/**
 * Open source class modified by Hassan 
 */
 ...
 */
public class MyAbstractWorkflow implements Workflow {
    //~ Static fields/initializers /////////////////////////////////////////////

    private static final Log log = LogFactory.getLog(MyAbstractWorkflow.class);
    ...
    public HashMap getAvailableActionsByStep(long id, Map inputs) {
    	...
    	try {
            ...
            for (Iterator iterator = currentSteps.iterator();
                ...
                Step step = (Step) iterator.next();
                l.addAll(getAvailableActionsForStep(wf, step, transientVars, ps));
                actionMap.put(new Integer(step.getStepId()),l);
            }
