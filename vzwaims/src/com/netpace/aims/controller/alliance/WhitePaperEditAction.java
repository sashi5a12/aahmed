 ...
 *
 * @struts.action path="/whitePaperEdit"                
 *                scope="request" 
 *				  name="AllianceSpotLightForm"
 *				  validate="true"
 *                input="/alliance/whitePaperCreateUpdate.jsp"
 * @struts.action-forward name="view" path="/allianceSpotlights.do?task=view&amp;spotLightTypeId=5" redirect="true"
 * @author Rizwan Qazi
 */

public class WhitePaperEditAction extends BaseAction 
{
  
    static Logger log = Logger.getLogger(WhitePaperEditAction.class.getName());
