 ...
 *
 * @struts.action path="/jmaResourceAction" 
 *                input="/alliance/allianceBusinessInfoUpdate.jsp"
 * @author Rizwan Qazi
 */
public class JMAAllianceResourceAction extends BaseAction
{

    static Logger log = Logger.getLogger(JMAAllianceResourceAction.class.getName());
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        if (resourceName.equals("tempFile"))
            ...
            resourceValues = AllianceBusInfoManager.getJMAAllianceResource(resourceName, alliance_id, user_type);
