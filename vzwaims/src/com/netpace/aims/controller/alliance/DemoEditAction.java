 ...
 *
 * @struts.action path="/demoEdit"                
 *                scope="request" 
 *				  name="AllianceSpotLightForm"
 *				  validate="true"
 *                input="/alliance/demoCreateUpdate.jsp"
 * @struts.action-forward name="view" path="/allianceSpotlights.do?task=view&amp;spotLightTypeId=7" redirect="true"
 * @author Rizwan Qazi
 */

public class DemoEditAction extends BaseAction 
{
  
    static Logger log = Logger.getLogger(DemoEditAction.class.getName());
