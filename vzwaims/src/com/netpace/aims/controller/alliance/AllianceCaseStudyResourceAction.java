 ...
 *
 * @struts.action path="/caseStudyResourceAction" 
 *                input="/alliance/allianceCaseStudiesView.jsp"
 * @author Rizwan Qazi
 */
public class AllianceCaseStudyResourceAction extends BaseAction 
{
  
    static Logger log = Logger.getLogger(AllianceCaseStudyResourceAction.class.getName());
								...
								HttpServletResponse response) throws Exception 
    {
		...
		Object [] resourceValues =  AimsCaseStudiesManager.getCaseStudyResource(resourceName, pkId, user_type);
