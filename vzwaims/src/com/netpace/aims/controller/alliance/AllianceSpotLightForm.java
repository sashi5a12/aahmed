...
/**
 * @struts.form name="AllianceSpotLightForm"
 */
public class AllianceSpotLightForm extends BaseValidatorForm {

	static Logger log = Logger.getLogger(AllianceSpotLightForm.class.getName());
	...
	public void reset (ActionMapping mapping, HttpServletRequest request)
	{
        ...
        {			
            try
            {
				AllianceSpotLightInfo = AllianceSpotlightsManager.getSpotLightInfo(spotLightId);
	...
	public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
        ...
        if (task_name.equalsIgnoreCase("create") || task_name.equalsIgnoreCase("edit"))
        {
			...
			{
                log.debug("AllianceSpotLightForm Blank spotlightName");
