 ...
 *
 * @struts.action path="/salesPartnerEdit"                
 *                scope="request" 
 *				  name="AllianceSpotLightForm"
 *				  validate="true"
 *                input="/alliance/salesPartnerCreateUpdate.jsp"
 * @struts.action-forward name="view" path="/allianceSpotlights.do?task=view&amp;spotLightTypeId=8" redirect="true"
 * @author Rizwan Qazi
 */

public class SalesPartnerEditAction extends BaseAction 
{
  
    static Logger log = Logger.getLogger(SalesPartnerEditAction.class.getName());
