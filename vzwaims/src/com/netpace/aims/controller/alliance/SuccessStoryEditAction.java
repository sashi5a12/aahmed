 ...
 *
 * @struts.action path="/successStoryEdit"                
 *                scope="request" 
 *				  name="AllianceSpotLightForm"
 *				  validate="true"
 *                input="/alliance/successStoryCreateUpdate.jsp"
 * @struts.action-forward name="view" path="/allianceSpotlights.do?task=view&amp;spotLightTypeId=6" redirect="true"
 * @author Rizwan Qazi
 */

public class SuccessStoryEditAction extends BaseAction 
{
  
    static Logger log = Logger.getLogger(SuccessStoryEditAction.class.getName());
