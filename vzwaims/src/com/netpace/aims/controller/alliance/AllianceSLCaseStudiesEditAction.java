 ...
 *
 * @struts.action path="/allianceSLCaseStudiesEdit"                
 *                scope="request" 
 *				  name="AllianceCaseStudyForm"
 *				  validate="true"
 *                input="/alliance/caseStudySLCreateUpdate.jsp"
 * @struts.action-forward name="view" path="/allianceSpotlights.do?task=view" redirect="true"
 * @author Rizwan Qazi
 */

public class AllianceSLCaseStudiesEditAction extends BaseAction 
{
  
    static Logger log = Logger.getLogger(AllianceSLCaseStudiesEditAction.class.getName());
