 ...
 *
 * @struts.action path="/testimonyEdit"                
 *                scope="request" 
 *				  name="AllianceSpotLightForm"
 *				  validate="true"
 *                input="/alliance/testimonyCreateUpdate.jsp"
 * @struts.action-forward name="view" path="/allianceSpotlights.do?task=view&amp;spotLightTypeId=4" redirect="true"
 * @author Rizwan Qazi
 */

public class TestimonyEditAction extends BaseAction 
{
  
    static Logger log = Logger.getLogger(TestimonyEditAction.class.getName());
