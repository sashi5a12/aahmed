 ...
 *
 * @struts.action path="/entSalesPartnerEdit"                
 *                scope="request" 
 *				  name="EntAppsSpotLightForm"
 *				  validate="true"
 *                input="/application/salesPartnerCreateUpdate.jsp"
 * @struts.action-forward name="view" path="/entAppsSpotlights.do?task=view&amp;spotLightTypeId=8" redirect="true"
 * @author Ahson Imtiaz
 */

public class EntSalesPartnerEditAction extends BaseAction
{

    static Logger log = Logger.getLogger(EntSalesPartnerEditAction.class.getName());
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        return new ActionForward("/entAppsSpotlights.do?task=view&spotLightTypeId=8&enterpriseAppsId=" + allianceSpotLightForm.getEnterpriseAppsId(), true);
    }
}
