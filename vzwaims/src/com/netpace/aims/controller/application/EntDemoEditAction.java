 ...
 *
 * @struts.action path="/entDemoEdit"                
 *                scope="request" 
 *				  name="EntAppsSpotLightForm"
 *				  validate="true"
 *                input="/application/demoCreateUpdate.jsp"
 * @struts.action-forward name="view" path="/entAppsSpotlights.do?task=view&amp;spotLightTypeId=7" redirect="true"
 * @author Ahson Imtiaz
 */

public class EntDemoEditAction extends BaseAction
{

    static Logger log = Logger.getLogger(EntDemoEditAction.class.getName());
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        return new ActionForward("/entAppsSpotlights.do?task=view&spotLightTypeId=7&enterpriseAppsId=" + allianceSpotLightForm.getEnterpriseAppsId(), true);
    }
}
