...
public class GetEntSpotLightTabsTag extends BodyTagSupport {

	static Logger log = Logger.getLogger(GetEntSpotLightTabsTag.class.getName());
	 
    protected String attributeName;
    protected String enterpriseAppsId;
    ...
    public java.lang.String getEnterpriseAppsId() {
        return this.enterpriseAppsId;
    }

    public void setEnterpriseAppsId(java.lang.String enterpriseAppsId) {
        this.enterpriseAppsId = enterpriseAppsId;
    }
			...
			for (Iterator iter = spotLightTypes.iterator(); iter.hasNext();)
			{
					...
					if (cnt == 1)
					{
						outBuffer.append("<table border=\"0\" cellpadding=\"0\" cellspacing=\"1\" width=\"100%\">")
								 .append("<tr>")
                        		 .append("<td	valign=\"middle\"	colspan=2 >")
					...
					if (selectedSpotlightTypeId == spotlightTypeId)
					{
						outBuffer.append("<td  align=\"center\" valign=\"middle\" onMouseOver=\"changeImages('").append(spotlightImageName).append("', 'images/").append(spotlightImageName).append("-over.gif'); changeImages('icontext',	'images/").append(spotlightImageName).append("_doctype.gif'); return true;\" ")
								 ...
								 .append("<a class=\"a\" href=\"")
								 .append("/aims/entAppsSpotlights.do?task=view&spotLightTypeId=")
								 .append(selectedSpotlightTypeId);

                        outBuffer.append("&enterpriseAppsId=")
                                 .append(getEnterpriseAppsId());
