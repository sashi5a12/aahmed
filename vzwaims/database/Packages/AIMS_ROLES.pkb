CREATE OR REPLACE PACKAGE BODY AIMS_ROLES
IS
...
/* -------------------------------------------------------------------------------------------------------------  */
   ...
   BEGIN
        ...
        */
        ...
        for c in (select privilege_id from aims_sys_privileges where available_to = substr(p_role_type,1,1) or available_to = 'B') loop
...
END AIMS_ROLES; -- Package Body AIMS_ROLES
/
