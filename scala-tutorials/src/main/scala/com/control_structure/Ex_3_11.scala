...
object Ex_3_11 {
  ...
  def main(args: Array[String]) {
    ...
    println(echoWhatYouGaveMe(List(1, 2, 3))) // prints "List(1, 2, 3)" 
    println(echoWhatYouGaveMe(Some("foo"))) // prints "Some(foo)" 
    println(echoWhatYouGaveMe(Person("John", "Doe"))) // prints "Person(John,Doe)"
