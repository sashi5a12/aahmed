			...
			<tr>
				<td>
					...
					<select onchange="OpenSample(this.value);">
						<option value="jsp/sample01.jsp">JSP : Sample 01 : Editor with all features generated via API</option>
						<option value="jsp/sample02.jsp" selected>JSP : Sample 02 : Editor with all features generated with JSP Taglib</option>
