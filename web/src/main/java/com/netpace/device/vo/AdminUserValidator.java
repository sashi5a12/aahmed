 ...
 * @author nraza
 */
@Component(value = "adminUserValidator")
public class AdminUserValidator extends LocalValidatorFactoryBean implements Validator {
    ...
    public void validate(Object info, Errors errors) {
        ...
        isNotEmpty(errors, messageSource, "roles", "NotBlank");
    }
}
