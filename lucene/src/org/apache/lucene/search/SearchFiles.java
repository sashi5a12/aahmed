...
public class SearchFiles {
  ...
  public static void main(String[] args) throws Exception {
    String usage = "Usage:\tjava org.apache.lucene.demo.SearchFiles [-index dir] [-field f] [-raw] [-paging hitsPerPage]";
    ...
    while (true) {
      ...
      for (int i = start; i < end; i++) {
        ...
        if (path != null) {
          ...
          SearchUtil test=new SearchUtil();
          
          try {
			test.parse(new File(path));
          ...
          System.out.println("   contents: " + test.getContents());
