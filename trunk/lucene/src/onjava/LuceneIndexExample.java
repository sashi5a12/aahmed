...
/**
 * LuceneIndexExample class provides a simple example of indexing with Lucene.
 * It creates a fresh index called "index-1" in a temporary directory every time
 * it is invoked and adds a single document with a single field to it.
 */
public class LuceneIndexExample {
	private static final String SMART_STOP_WORDS[] = { "a", "a's", "able",
	...
	public static void main(String args[]) throws Exception {
		...
		Analyzer analyzer = new StandardAnalyzer(SMART_STOP_WORDS);
