...
public class IndexHTML {
  ...
  private static final String INDEX_DIR="E:/Dev/Others/lucene/index";
  private static final String ROOT_DIR="C:/Users/aahmed.NETPACE/Desktop/public";
  ...
  public static void main(String args[]) {
    try {
      ...
      writer = new IndexWriter(INDEX_DIR, new StandardAnalyzer(SearchUtil.SMART_STOP_WORDS), create, new IndexWriter.MaxFieldLength(1000000));
  ...
  private static void indexDocs(File file) throws Exception {
    ...
    else if (file.getPath().endsWith("header.jsp") || file.getPath().endsWith("footer.jsp")){}
    else if (
