...
#
# $Id: catalina.sh,v 1.7 2009/11/04 01:12:13 amakda Exp $
# -----------------------------------------------------------------------------
...
CATALINA_OPTS="-Djava.awt.headless=true -Dfile.encoding=ISO-8859-1"
...
################################################################################
export CLASSPATH=/usr/java/ProjectLibraries/ojdbc14.jar:$CLASSPATH
