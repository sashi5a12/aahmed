...
<%javaApplicationUpdateForm.setCurrentPage("page5");%>
...
<div id="contentBox" style="float: left">
	<div class="homeColumnTab">
		...
		<div class="contentbox">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="50%" valign="top" class="pR5px" >
									...
									<tr>
										<th>
											...
											<logic:notEmpty name="javaApplicationUpdateForm" property="companyLogoFileName" scope="request">
												<a href="<bean:message key="ManageApplicationForm.manage.app.resource.url"	bundle="com.netpace.aims.action.MANAGE_APPLICATION_MESSAGE"/>?app_res=JavaCompanyLogo&app_id=<bean:write	name="javaApplicationUpdateForm"	property="appsId"	/>"
													class="a" target="_blank"><bean:write name="javaApplicationUpdateForm" property="companyLogoFileName" /></a>
											</logic:notEmpty>									
										</th>
									</tr>
									<tr>
										<td>
											...
											<%=Utility.getEllipseString(42,javaApplicationUpdateForm.getTitle())%>
										</td>
									</tr>
									<tr>
										<td>
											...
											<logic:notEmpty name="javaApplicationUpdateForm" property="titleImageFileName" scope="request">
												<a href="<bean:message key="ManageApplicationForm.manage.app.resource.url"	bundle="com.netpace.aims.action.MANAGE_APPLICATION_MESSAGE"/>?app_res=TitleImage&app_id=<bean:write	name="javaApplicationUpdateForm"	property="appsId"	/>"
													class="a" target="_blank"><bean:write name="javaApplicationUpdateForm" property="titleImageFileName" /></a>
											</logic:notEmpty>									
										</td>
									</tr>															
									<tr>
					...
					<td width="50%" valign="top"   class="pL5px"   >
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				System.out.println("isVerizonUser isVerizonUser isVerizonUser isVerizonUser  isVerizonUser");
				System.out.println(isVerizonUser);
