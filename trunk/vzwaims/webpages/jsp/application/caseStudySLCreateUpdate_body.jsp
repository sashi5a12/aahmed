...
<html:form action="/entSLCaseStudiesEdit.do" enctype="multipart/form-data" onsubmit="showProcessingInfoPopup()">	
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr> 
		<td width="30">&nbsp;</td>
		<td width="603">
			<strong><font color="#333333" size="+1" face="Verdana, Arial, Helvetica, sans-serif"><bean:message key="EntAppsSpotlights.entAppSpotlights" bundle="com.netpace.aims.action.MANAGE_APPLICATION_MESSAGE"/></font></strong> 
            -
          				...
          				<table width="100%" border="0" cellspacing="10" cellpadding="0">
							...
							<tr> 
								...
								<td class="body" align="left">
									...
									<br/>
									<a class="a" target="_blank" href='/aims/entAppsSLResourceAction.do?resource=caseStudyDoc&resourceId=<bean:write name="AllianceCaseStudyForm" property="caseStudyId"/>' >
