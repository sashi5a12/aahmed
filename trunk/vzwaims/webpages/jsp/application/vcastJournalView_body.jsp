...
<%VcastApplicationUpdateForm.setCurrentPage("page4");%>
<%VcastApplicationUpdateForm.setJournalType("PR");%>
<%VcastApplicationUpdateForm.setJournalText("");%>
                    ...
                    <tr>
                        <td>
                            <div class="redBtn" style="float:right; margin-left:10px;float:right; margin-top:3px" id="AllSubmit" title="Submit">
                                <div><div><div onClick="document.forms[0].appSubmitType.value='paging';document.forms[0].task.value='submitpage4View';document.forms[0].submit();">Submit</div></div></div>
                            </div>
                        </td>
                    </tr>
                <% }else {}%>
