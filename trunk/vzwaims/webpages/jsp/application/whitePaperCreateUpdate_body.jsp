...
<html:form action="/entWhitePaperEdit.do" enctype="multipart/form-data" onsubmit="showProcessingInfoPopup()">
    <html:hidden property="spotlightTypeId" value="<%=AimsConstants.SPOTLIGHT_WHITE_PAPER%>"/>
    <html:hidden property="enterpriseAppsId"/>

    <%@ include file="include/entAppSpotlightsTabs.jsp" %>
    <aims:getEntSpotlightsTab attributeName="<%=AimsConstants.SPOTLIGHT_WHITE_PAPER%>"
        ...
        <table width="100%" cellspacing="0" cellpadding="5" class="GridGradient">
            <tr>
                <th align="right" style="text-align:right">
                    <strong>White Paper Name&nbsp;<span class="requiredText">*</span>:</strong>
                </th>
                <th align="left">
            ...
            <tr>
                <td align="right">
                    <strong>White Paper Document&nbsp;<span class="requiredText">*</span>:</strong>
                </td>
                <td align="left">
