...
<div class="homeColumnTab lBox">
	...
	<aims:getEntSpotlightsTab attributeName="<%=AimsConstants.SPOTLIGHT_SUCCESS_STORY%>" enterpriseAppsId="<%=enterpriseAppsId%>"/>	
	...
	<div class="contentbox">
		<table width="100%" cellspacing="0" cellpadding="5" class="Grid2" border="1">
			<tr>
				<th align="center"><strong>Success Story Name</strong></th>
				<th align="center"><strong>Success Story Description</strong></th>
				<th align="center"><strong>Success Story Document</strong></th>
				...
				<tr>
					<td align="left">
						<logic:notEqual name="spotlight" property="status" value="ACCEPT">
							<a href='/aims/entAppsSpotLightSetup.do?task=editForm&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_SUCCESS_STORY%>&spotlightId=<bean:write name="spotlight" property="spotlightId"/>&enterpriseAppsId=<%=enterpriseAppsId%>' class="a">
					...
					<td align="center" style="vertical-align: middle">
	                <%if (AimsSecurityManager.checkAccess(request, "SPOTLIGHT_PAGE", AimsSecurityManager.DELETE)) {	%>					
						<a href='/aims/entAppsSpotlights.do?task=delete&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_SUCCESS_STORY%>&spotlightId=<bean:write name="spotlight" property="spotlightId"/>&enterpriseAppsId=<%=enterpriseAppsId%>' class="a">
	             ...
	             <tr> 
	                 <td colspan="8" align="right" > 
	                 	<div class="redBtn" style=" margin-left:5px;float:right; margin-top:3px" id="Create"
	                          title="Create">
	                         <div>
	                             <div><div onclick="window.location='/aims/entAppsSpotLightSetup.do?task=createForm&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_SUCCESS_STORY%>&enterpriseAppsId=<%=enterpriseAppsId%>'">Create</div></div>
	                         </div>
	                     </div>
	                 </td>
	             </tr>
