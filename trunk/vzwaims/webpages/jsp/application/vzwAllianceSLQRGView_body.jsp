...
<a class="a" href="/aims/tools/spo3.20.03.doc">Quick Reference Guide</a>
<br/>
<a class="a" href="/aims/tools/spo.sample3.20.03a.doc">Quick Reference Guide Example</a>
<br/>
<br/>
...
<div class="contentbox">
    <table width="100%" cellspacing="0" cellpadding="5" class="Grid2" border="1">
        <tr>
            <th align="center">
                <strong>Quick Reference Guide Name</strong>
            </th>
            <th align="center">
                <strong>Quick Reference Guide Description</strong>
            </th>
            <th align="center">
                <strong>Quick Reference Guide Document</strong>
            </th>
            <th align="center">
                ...
                <td align="center">
                    <logic:equal name="spotlight" property="status" value="NEW">                        
                        <div class="redSmallBtn" id="Create" title="Accept">
                            <div>
                                <div>
                                    <div onclick="window.location='/aims/entAppsSpotlights.do?task=changeStatus&enterpriseAppsId=<%=enterpriseAppsId%>&vzwStatus=ACCEPT&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_QRG%>&spotlightId=<bean:write name="spotlight" property="spotlightId"/>'">
                                        Accept
                                    </div>
                                </div>
                            </div>
                ...
                <td align="center">
                    <logic:equal name="spotlight" property="status" value="NEW">                        
                        <div class="redSmallBtn" id="Create" title="Reject">
                            <div>
                                <div>
                                    <div onclick="window.location='/aims/entAppsSpotlights.do?task=changeStatus&enterpriseAppsId=<%=enterpriseAppsId%>&vzwStatus=REJECT&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_QRG%>&spotlightId=<bean:write name="spotlight" property="spotlightId"/>'">
                                        Reject
                                    </div>
                                </div>
                            </div>
