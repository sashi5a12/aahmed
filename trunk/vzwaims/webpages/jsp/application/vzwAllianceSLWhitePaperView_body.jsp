...
<div class="homeColumnTab lBox">
	...
	<aims:getEntSpotlightsTab attributeName="<%=AimsConstants.SPOTLIGHT_WHITE_PAPER%>" enterpriseAppsId="<%=enterpriseAppsId%>" />
	...
	<H1>Manage White Papers</H1>
	<DIV class="headRightCurveblk"></DIV>
	
	<div class="contentbox">
		<table width="100%" cellspacing="0" cellpadding="5" class="Grid2" border="1">
			<tr>
				<th align="center"><strong>White Paper Name</strong></th>
				<th align="center"><strong>White Paper Description</strong></th>
				<th align="center"><strong>White Paper Document</strong></th>
						...
						<td align="center">
							<logic:equal name="spotlight" property="status" value="NEW">
								<div class="redSmallBtn" id="Create" title="Accept">
									<div><div>
										<div
											onclick="window.location='/aims/entAppsSpotlights.do?task=changeStatus&enterpriseAppsId=<%=enterpriseAppsId%>&vzwStatus=ACCEPT&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_WHITE_PAPER%>&spotlightId=<bean:write name="spotlight" property="spotlightId"/>'">
											Accept
										</div>
									</div></div>
								</div>
							...
							<logic:equal name="spotlight" property="status" value="NEW">
								<div class="redSmallBtn" id="Create" title="Reject">
									<div>
										<div>
											<div
												onclick="window.location='/aims/entAppsSpotlights.do?task=changeStatus&enterpriseAppsId=<%=enterpriseAppsId%>&vzwStatus=REJECT&spotLightTypeId=<%=AimsConstants.SPOTLIGHT_WHITE_PAPER%>&spotlightId=<bean:write name="spotlight" property="spotlightId"/>'">
												Reject
											</div>
										</div>
									</div>
