...
<html:form action="/entTestimonyEdit.do" enctype="multipart/form-data" onsubmit="showProcessingInfoPopup()">
    <html:hidden property="spotlightTypeId" value="<%=AimsConstants.SPOTLIGHT_TESTIMONY%>"/>
    <html:hidden property="enterpriseAppsId"/>

    <%@ include file="include/entAppSpotlightsTabs.jsp" %>
    <aims:getEntSpotlightsTab attributeName="<%=AimsConstants.SPOTLIGHT_TESTIMONY%>"
...
<table width="100%" cellspacing="0" cellpadding="5" class="GridGradient">
        ...
        <tr>
            <td align="right">
                <strong>Testimony Description :</strong>
            </td>
            <td  align="left">
                <html:textarea styleClass="textareaField" property="spotlightDesc" rows="4" cols="50" onkeyup="TrackCount(this,'textCountSpotlightDesc',500)" onkeypress="LimitText(this,500)"></html:textarea>
                <br/>
        ...
        <tr>
            <td align="right">
                <strong>Testimony Document :</strong>
            </td>
            <td  align="left">
