<% String enterpriseAppsId = (String)request.getParameter("enterpriseAppsId");
	if (enterpriseAppsId == null) {
		com.netpace.aims.controller.application.EntAppsSpotLightForm Entfrm = (com.netpace.aims.controller.application.EntAppsSpotLightForm) request.getAttribute("EntAppsSpotLightForm");
		if (Entfrm != null) enterpriseAppsId = Entfrm.getEnterpriseAppsId().toString();
	}
%>
<!-- <%=enterpriseAppsId%> -->
