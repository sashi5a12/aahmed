...
<html:form action="/salesPartnerEdit.do" enctype="multipart/form-data">	
<html:hidden  property="spotlightTypeId" value="<%=AimsConstants.SPOTLIGHT_SALES_PARTNERS%>" />
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr><td width="100%">
					<table class="sectable" width="100%" height="100%">
						<tr class="sectitle"><td class="aimssecheading">Sales Partner</td></tr>
						<tr><td>
	          				<table width="100%" border="0" cellspacing="10" cellpadding="0">
								<tr> 
									<td width="36%" align="right" class="text">
										<strong>Sales Partner Name</strong>
									</td>		
									<td width="64%" align="left" class="body">
								...
								<tr> 
									<td class="text" align="right">
										<strong>Sales Partner Description</strong>
									</td>
								...
								<tr> 
									<td class="text" align="right">
										<strong>Sales Partner Document</strong>
									</td>
									<td class="body" align="left">
