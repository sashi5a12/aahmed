					    ...
					    <table class="sectable" width="100%">
                            ...
                            <tr>
                                ...
                                <td class="text" valign="top">
                           			 <html:text  property="deviceModel" size="30" maxlength="50"/>
                                </td>
							...
							<tr>
                                ...
                                <td class="text" valign="top">
                           			 <html:text property="deviceMfgBy" size="30" maxlength="50"/>
                                </td>
                            </tr>
							<tr> 
									<td colspan="2">
								...
								<tr> 
									...
									<td class="text" align="left">
										<html:text  property="mfgWebSiteUrl" size="30" maxlength="50" />
									</td>
								</tr
								><tr> 
									<td align="right">
