 ...
 * @author Rizwan
 */
public class AimsNotificationConstants
{
    ...
    //Event IDs for java applications
    public static final String EVENT_JAVA_APP_STATUS_CHANGE = "2002";
    public static final String EVENT_JAVA_APP_APPROVAL = "2003";
    public static final String EVENT_JAVA_APP_DELETED = "2101";
    public static final String EVENT_JAVA_APP_PROGRAMMING_CONTENT_APPROVAL = "2004";    
    public static final String EVENT_JAVA_APP_PROGRAMMING_CONTENT_RFI = "2005";    
    public static final String EVENT_JAVA_APP_PROGRAMMING_CONTENT_DENY = "2006";
    public static final String EVENT_JAVA_APP_LEGAL_CONTENT_APPROVAL = "2007";    
    public static final String EVENT_JAVA_APP_LEGAL_CONTENT_DENY = "2008";    
    public static final String EVENT_JAVA_APP_LEGAL_CONTENT_RFI = "2009";    
    public static final String EVENT_JAVA_APP_TAX_APPROVAL_PENDING = "2010";    
    public static final String EVENT_JAVA_APP_TAX_APPROVAL_RFI = "2011";
    public static final String EVENT_JAVA_APP_PROGRAMMING_CONTENT_RESUBMIT = "2012";
    public static final String EVENT_JAVA_APP_LEGAL_CONTENT_RESUBMIT = "2013";
    public static final String EVENT_JAVA_APP_TAX_RESUBMIT = "2014";
    ...
    public static final String EVENT_JMA_PARTNER_REQ_RENEW_CONTRACT = "170";
    public static final String EVENT_JMA_PARTNER_RESUBMIT_SOLUTION = "171";
    public static final String EVENT_JMA_ALLIANCE_REGISTRATION_SUBMITTED="172";
    public static final String EVENT_JMA_PUBLIC_JOURNAL_ENTRY="173";
    public static final String EVENT_JMA_APP_VERTICAL_CHECKED="174";
    public static final String EVENT_JMA_APP_VERTICAL_UNCHECKED="175";
    public static final String EVENT_JMA_ALLIANCE_RESUBMITTED="176";
    public static final String JMA_ALLIANCE_REJECTED="177";
    
	//Alliance service notifications
    public static final String EVENT_ALLIANCE_SERVICE_ACCOUNT_DISABLED = "2100";
    public static final String EVENT_SETTLEMENT_SERVICE_FOLLOWUP = "2102";

    
     public static final String EVENT_JMA_SALES_LEAD_SUBMITTED_BY_ADMIN="3001";
    public static final String EVENT_JMA_SALES_LEAD_UPDATED_BY_ADMIN="3002";
    public static final String EVENT_JMA_SALES_LEAD_CLOSED_BY_ADMIN="3003";
    public static final String EVENT_JMA_SALES_LEAD_SUBMITTED_BY_PARTNER="3004";
    public static final String EVENT_JMA_SALES_LEAD_UPDATED_BY_PARTNER="3005";
    public static final String EVENT_JMA_SALES_LEAD_CLOSED_BY_PARTNER="3006";
    ...
    public static final String PLACE_HOLDER_RESUBMIT_ALLIANCE_SERVICE_URL="API_RESUBMIT_URL";
    public static final String PLACE_HOLDER_CAUSE_MESSAGE="API_ERROR_MESSAGE";
    
    public static final String PLACE_HOLDER_VERTICAL_NAME="VERTICAL_NAME";
