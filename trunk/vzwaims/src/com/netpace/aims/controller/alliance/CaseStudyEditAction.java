 ...
 *
 * @struts.action path="/caseStudyEdit"                
 *                scope="request" 
 *				  name="AllianceSpotLightForm"
 *				  validate="true"
 *                input="/alliance/caseStudySLCreateUpdate.jsp"
 * @struts.action-forward name="view" path="/allianceSpotlights.do?task=view&amp;spotLightTypeId=1" redirect="true"
 * @author Rizwan Qazi
 */

public class CaseStudyEditAction extends BaseAction 
{
  
    static Logger log = Logger.getLogger(CaseStudyEditAction.class.getName());
