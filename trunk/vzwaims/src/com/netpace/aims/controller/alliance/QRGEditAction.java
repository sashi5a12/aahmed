 ...
 *
 * @struts.action path="/qrgEdit"                
 *                scope="request" 
 *				  name="AllianceSpotLightForm"
 *				  validate="true"
 *                input="/alliance/qrgCreateUpdate.jsp"
 * @struts.action-forward name="view" path="/allianceSpotlights.do?task=view&amp;spotLightTypeId=9" redirect="true"
 * @author Rizwan Qazi
 */

public class QRGEditAction extends BaseAction 
{
  
    static Logger log = Logger.getLogger(QRGEditAction.class.getName());
    ...
    {      
		...
		if (taskname.equalsIgnoreCase("create"))
		{
			 ...
			 Collection AimsSpotLights = AllianceSpotlightsManager.getSpotLightRecords
                                                (alliance_id, user_type, spotLightTypeId);
