 ...
 *
 * @struts.action path="/salesCollateralEdit"                
 *                scope="request" 
 *				  name="AllianceSpotLightForm"
 *				  validate="true"
 *                input="/alliance/salesCollateralCreateUpdate.jsp"
 * @struts.action-forward name="view" path="/allianceSpotlights.do?task=view&amp;spotLightTypeId=3" redirect="true"
 * @author Rizwan Qazi
 */

public class SalesCollateralEditAction extends BaseAction 
{
  
    static Logger log = Logger.getLogger(SalesCollateralEditAction.class.getName());
