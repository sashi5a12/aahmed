 ...
 *
 * @struts.action path="/certifiedAppReport"
 *                scope="request"
 *                name="GINReportForm"
 *                input="/reports/certifiedAppReport.jsp"
 * @struts.action-forward name="view" path="/reports/certifiedAppReport.jsp"
 * @struts.action-forward name="excel" path="/reports/certifiedAppReportExcel.jsp"
 * @author Fawad Sikandar
 */

public class GINCertifiedAppReportAction extends BaseAction
{

    static Logger log = Logger.getLogger(GINCertifiedAppReportAction.class.getName());
                                 ...
                                 HttpServletResponse response) throws Exception
    {
     ...
     Collection collection = AimsGINReportManager.getGINCertifiedAppList();
