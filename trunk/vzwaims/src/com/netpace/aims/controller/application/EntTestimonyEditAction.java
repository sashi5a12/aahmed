 ...
 *
 * @struts.action path="/entTestimonyEdit"                
 *                scope="request" 
 *				  name="EntAppsSpotLightForm"
 *				  validate="true"
 *                input="/application/testimonyCreateUpdate.jsp"
 * @struts.action-forward name="view" path="/entAppsSpotlights.do?task=view&amp;spotLightTypeId=4" redirect="true"
 * @author Ahson Imtiaz
 */

public class EntTestimonyEditAction extends BaseAction
{

    static Logger log = Logger.getLogger(EntTestimonyEditAction.class.getName());
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        return new ActionForward("/entAppsSpotlights.do?task=view&spotLightTypeId=4&enterpriseAppsId=" + allianceSpotLightForm.getEnterpriseAppsId(), true);
    }
}
