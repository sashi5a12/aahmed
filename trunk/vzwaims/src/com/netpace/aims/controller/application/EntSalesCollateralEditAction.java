 ...
 *
 * @struts.action path="/entSalesCollateralEdit"                
 *                scope="request" 
 *				  name="EntAppsSpotLightForm"
 *				  validate="true"
 *                input="/application/salesCollateralCreateUpdate.jsp"
 * @struts.action-forward name="view" path="/entAppsSpotlights.do?task=view&amp;spotLightTypeId=3" redirect="true"
 * @author Ahson Imtiaz
 */

public class EntSalesCollateralEditAction extends BaseAction
{

    static Logger log = Logger.getLogger(EntSalesCollateralEditAction.class.getName());
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        return new ActionForward("/entAppsSpotlights.do?task=view&spotLightTypeId=3&enterpriseAppsId=" + allianceSpotLightForm.getEnterpriseAppsId(), true);
    }
}
