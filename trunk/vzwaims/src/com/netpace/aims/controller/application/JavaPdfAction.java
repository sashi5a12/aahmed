...
import com.netpace.aims.bo.application.AimsJavaPdf;
...
/**
 * @struts.action path="/javaPdf"
 *                scope="request"
 * @struts.action-forward name="error" path="/application/javaPdfError.jsp" 
 */
public class JavaPdfAction extends BaseAction
{

    static Logger log = Logger.getLogger(JavaPdfAction.class.getName());
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        int pdfSize = Integer.parseInt(appResource.getMessage("file.javaPdf.sizelimit"));
        Object o_param;
        String app_id;
        String forward=null;
        ...
        {            
            ...
            {                
                ...
                HashMap  appMap = JavaApplicationManager.getUserGuideData(new Long(app_id), allianceId);
                
                if (!appMap.isEmpty()){
                	AimsJavaPdf.getneratePdf(appMap, baos);
