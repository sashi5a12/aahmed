 ...
 *
 * @struts.action path="/entSuccessStoryEdit"                
 *                scope="request" 
 *				  name="EntAppsSpotLightForm"
 *				  validate="true"
 *                input="/application/successStoryCreateUpdate.jsp"
 * @struts.action-forward name="view" path="/entAppsSpotlights.do?task=view&amp;spotLightTypeId=6" redirect="true"
 * @author Ahson Imtiaz
 */

public class EntSuccessStoryEditAction extends BaseAction
{

    static Logger log = Logger.getLogger(EntSuccessStoryEditAction.class.getName());
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        return new ActionForward("/entAppsSpotlights.do?task=view&spotLightTypeId=6&enterpriseAppsId=" + allianceSpotLightForm.getEnterpriseAppsId(), true);
    }
}
