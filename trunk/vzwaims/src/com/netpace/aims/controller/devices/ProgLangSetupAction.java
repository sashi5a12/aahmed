 ...
 *
 * @struts.action path="/progLangsSetup"    
 *				  name="ProgLangForm"
 *                validate="false"
 *                scope="request" 
 * @struts.action-forward name="editForm" path="/masters/progLangEditForm.jsp"
 * @struts.action-forward name="createForm" path="/masters/progLangCreate.jsp"
 * @author Rizwan Qazi 
 */
public class ProgLangSetupAction extends BaseAction
{

    static Logger log = Logger.getLogger(ProgLangSetupAction.class.getName());
