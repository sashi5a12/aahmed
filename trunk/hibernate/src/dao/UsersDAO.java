...
public class UsersDAO extends BaseHibernateDAO {
	...
	public List findByExample(Users instance) {
		...
		try {
			List results = getSession().createCriteria("model.Users").add(
	...
	public List findByHomeStreet(Object homeStreet) {
		return findByProperty(HOME_STREET, homeStreet);
	}

	public List findByHomeZipcode(Object homeZipcode) {
		return findByProperty(HOME_ZIPCODE, homeZipcode);
	}

	public List findByHomeCity(Object homeCity) {
		return findByProperty(HOME_CITY, homeCity);
	}
