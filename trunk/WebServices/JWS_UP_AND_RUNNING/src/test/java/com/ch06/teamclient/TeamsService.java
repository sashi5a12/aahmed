 ...
 * 
 */
@WebServiceClient(name = "TeamsService", targetNamespace = "http://ch06.com/", wsdlLocation = "http://localhost:8080/jwsur/TeamsService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TEAMSSERVICE_QNAME = new QName("http://ch06.com/", "TeamsService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/jwsur/TeamsService?wsdl");
    ...
    public Teams getTeamsPort() {
        return super.getPort(new QName("http://ch06.com/", "TeamsPort"), Teams.class);
    }
    ...
    public Teams getTeamsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ch06.com/", "TeamsPort"), Teams.class, features);
    }
