 ...
 * generated in the com.ch03.SkiImageC package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetImagesResponse_QNAME = new QName("http://ch03.com/", "getImagesResponse");
    private final static QName _GetImageResponse_QNAME = new QName("http://ch03.com/", "getImageResponse");
    private final static QName _GetImage_QNAME = new QName("http://ch03.com/", "getImage");
    private final static QName _GetImages_QNAME = new QName("http://ch03.com/", "getImages");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ch03.SkiImageC
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ch03.com/", name = "getImagesResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ch03.com/", name = "getImageResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ch03.com/", name = "getImage")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ch03.com/", name = "getImages")
