    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(sample.ch01.timclient.TimeServerImplService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = sample.ch01.timclient.TimeServerImplService.class.getResource(".");
