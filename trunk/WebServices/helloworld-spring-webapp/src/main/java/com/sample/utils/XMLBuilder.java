...
public class XMLBuilder {
    ...
    private final static String SERVER_ADDRESS = "http://localhost:8080/jersey/services";
    ...
    public static String getAllSubjects(Integer grade) {
        ...
        for (String subject : subjects) {
            ...
            subjectElement.addAttribute("href", SERVER_ADDRESS + "/gradeservice/grade/" + grade + "/subject/" + subject);
        }
        return doc.asXML();
    }
