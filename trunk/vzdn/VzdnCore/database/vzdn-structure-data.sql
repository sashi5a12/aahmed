...
insert  into `vzdn_role_privileges`(`role_id`,`privilege_id`) values (5,1),(5,2),(5,3),(5,4),(5,5),(5,6),(5,7),(5,8),(5,9),(5,10),(5,11);
...
insert  into `vzdn_sys_roles`(`role_id`,`role_name`,`role_description`,`type_id`,`created_by`,`created_date`,`last_updated_by`,`last_updated_date`,`vzdn_role_mapping_id`) values (1,'Forum User','Forum User',1,NULL,NULL,NULL,NULL,5002),(2,'Forum Admin','Forum Admin',3,NULL,NULL,NULL,NULL,5001),(3,'Blog User','Blog User',1,NULL,NULL,NULL,NULL,4002),(4,'Blog Admin','Blog Admin',2,NULL,NULL,NULL,NULL,4001),(5,'System Admin','VzdnCore Admin',2,NULL,NULL,NULL,NULL,1001),(6,'Vzdncore Default','Vzdncore Default Role',4,NULL,NULL,NULL,NULL,0);
...
insert  into `vzdn_type_defs`(`type_def_id`,`type_name`,`type_description`,`created_by`,`created_date`,`last_updated_by`,`last_updated_date`) values (1,'Role Type','Role Type',NULL,NULL,NULL,NULL);
