...
public class GlobalNavProperties {
    ...
    private static Logger log = Logger.getLogger(GlobalNavProperties.class.getName());
    ...
    public String getProperty(String key) {
        ...
        if(property == null) {
            log.debug("GlobalNavProperties.getProperty: Property "+key+" not found in "+propsFileName);
        }
        return property;
    }
}
