							...
							<div class="boxContent">
								...
								<div class="boxContBM pR10">
									...
									<div class="txtContent">
										...
										<#if sh_has_next==false>
										<br>
										</#if>																		
										<ul class="arrow">
											<li><a href="<%=request.getContextPath()%>${sh.link}"><strong>${sh.link_text}</strong></a></li>
										</ul>
										<#if sh_has_next>
										<div class="sepratorGray">
											<img src="<%=request.getContextPath()%>/images/s.gif" width="1" height="1">
										</div>
										</#if>
										</#list>									
									</div>
