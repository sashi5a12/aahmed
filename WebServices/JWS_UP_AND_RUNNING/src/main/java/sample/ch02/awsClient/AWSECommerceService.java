    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(sample.ch02.awsClient.AWSECommerceService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = sample.ch02.awsClient.AWSECommerceService.class.getResource(".");
