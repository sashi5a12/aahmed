 ...
 * generated in the sample.ch01.team.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetTeamResponse_QNAME = new QName("http://team.ch01.sample/", "getTeamResponse");
    private final static QName _GetTeam_QNAME = new QName("http://team.ch01.sample/", "getTeam");
    private final static QName _GetTeams_QNAME = new QName("http://team.ch01.sample/", "getTeams");
    private final static QName _GetTeamsResponse_QNAME = new QName("http://team.ch01.sample/", "getTeamsResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: sample.ch01.team.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://team.ch01.sample/", name = "getTeamResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://team.ch01.sample/", name = "getTeam")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://team.ch01.sample/", name = "getTeams")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://team.ch01.sample/", name = "getTeamsResponse")
